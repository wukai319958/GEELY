...
namespace DataAccess.Assorting
{
    ...
    /// 托盘抵达分拣口的通知。
    /// </summary>
    public class AST_PalletArrived
    {
        /// <summary>
        /// 获取或设置自增主键。
        /// </summary>
        ...
        /// 获取或设置配送批次。
        /// </summary>
        //[Index("UK_AST_PalletArrived", 1, IsUnique = true)]
        [Index]
        [Required]
        [MaxLength(100)]
        ...
        /// 获取或设置抵达的托盘的外键。
        /// </summary>
        //[Index("UK_AST_PalletArrived", 2, IsUnique = true)]
        [Index]
        ...
        /// </summary>
        //[Index("UK_AST_PalletArrived", 3, IsUnique = true)]
        [MaxLength(4000)]
        ...
        /// 获取或设置关联的通讯消息。
        /// </summary>
        public virtual AST_PalletArrivedMessage AST_PalletArrivedMessage { get; set; }
    }
}